...
class AWAC(BaseAgent):
    def __init__(self, args, env, env_params):
        ...
        self._awac_lambda = args.awac_lambda
        self._exp_adv_max = args.exp_adv_max
    ...
    def _update_network(self, future_p=None):
        ...
        with torch.no_grad():
            ...
            q = r_tensor + self.args.gamma * self.critic_network(inputs_next_norm_tensor, actions_next)
            adv = q - v
