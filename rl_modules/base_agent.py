...
class BaseAgent:
    def __init__(self, args, env, env_params):
        ...
        self.action_norm = normalizer(size=env_params['action'], default_clip_range=self.args.clip_range)
    ...
    def _update_normalizer(self, episode_batch):
        ...
        self.action_norm.update(buffer_temp['actions'])
        # recompute the stats
        self.o_norm.recompute_stats()
        self.g_norm.recompute_stats()
        self.action_norm.recompute_stats()
    ...
    def sample_batch(self, future_p=None):
        ...
        self.o_norm.update(transitions['obs'])
        self.g_norm.update(transitions['g'])
        self.action_norm.update(transitions['actions'])
        self.o_norm.recompute_stats()
        self.g_norm.recompute_stats()
        self.action_norm.recompute_stats()
